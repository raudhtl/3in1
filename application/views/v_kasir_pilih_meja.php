...
<?php } else { ?>
  <div style="margin-top:1.5em; margin-right: 30px; float:right; padding-top:21px; padding-bottom:25px;">
    <a href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class ="fa fa-bell fa-2x " style="color:white;"><br></i></span></a>
  </div>
<?php } ?>
...
<!--content-->
	<div class="menu">
		<div class="container">
			<div class="menu-top">
				<div class="col-md-4 menu-left animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">
					...
					<span>Pilih Meja Yang Akan Melakukan Pembayaran</span>
				</div>
				<div class="clearfix"> </div>
			</div>
        ...
        <div class="col-md-4 menu-bottom1">
          <form action="Pilih_meja/pilih_bayar" method="post">
          <div class="btm-right">
